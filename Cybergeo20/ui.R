  ...
  navlistPanel(
    ...
    tabPanel("Global Stats",
             fluidRow(h2("Global Stats"),
                      column(4, sliderInput("dateRange", label = "Time Range",
                                            min = 1996, max = 2015, value = c(1996,2015), step = 1)),
                      column(4, h4("Number of scientific articles published")),
                      column(4, verbatimTextOutput('Npapers')),
                      column(4, " "),
                      column(4, h4("Number of Authors")),
                      column(4, verbatimTextOutput('Nauthors')),
