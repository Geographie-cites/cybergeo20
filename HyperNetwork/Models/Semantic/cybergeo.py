...
def extract_relevant_cybergeo (kwLimit) :
    corpus = utils.get_data('SELECT id FROM refdesc INNER JOIN cybergeo ON cybergeo.id=refdesc.id WHERE abstract_keywords IS NOT NULL;','../../Data/dumps/20160126_cybergeo.sqlite3')
