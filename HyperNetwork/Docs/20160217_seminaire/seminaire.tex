...
\section{Collections des donn{\'e}es}
...
{\centering
\includegraphics[width=0.5\textwidth]{figures/velib}
}

\bigskip

Traffic routier : collecte de \textit{sytadin} (pas d'API)
...
Apr{\`e}s raffinement, $\simeq$ 947 r{\'e}f{\'e}rences de cybergeo exploitables, sur $\simeq 1200$ ; certaines inexistantes, d'autres mal enregistr{\'e}es sur scholar% $\rightarrow$ possibilit{\'e} de compl{\'e}ter {\`a} la main (long...).


\textit{418670 Noeuds et 570352 Liens ; Diam{\'e}tre : 9 ; Densit{\'e} : 3.25E-6 ; degr{\'e} moyen : 2.724284}
